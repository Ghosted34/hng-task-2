window.addEventListener('DOMContentLoaded',()=>{
   ...
   mobileLinks.forEach(mobileLink => mobileLink.addEventListener('click',()=>{
...
let getCurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'fa-moon' : 'fa-sun'
...
let resumeArea = document.querySelector('.resume')
